//
//  ChannelSelectioniPadViewController.m
//  BFMan
//
...
@interface ChannelSelectioniPadViewController ()

@end

@implementation ChannelSelectioniPadViewController
@synthesize channelIds, channelNames, delegate;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    // Configure the cell...
    NSString *channelName = [channelNames objectAtIndex:indexPath.row];
